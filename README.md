...
| มีแล้ว                                   | ยังไม่มี                             |
| ---------------------------------------- | ------------------------------------ |
| เข้าสู่ระบบ (ปิด public sign-up)         | ตรวจลำดับเวลาและความครบถ้วน (PR-03)  |
| RBAC 8 บทบาท พร้อมสิทธิ์รายหน้าที่       | สายอนุมัติและเลขเอกสาร (PR-04)       |
| RLS ทุกตาราง                             | แม่แบบและการสร้าง PDF (PR-05, PR-06) |
| App shell ภาษาไทยที่กรองเมนูตามสิทธิ์    | คลังวัสดุและครุภัณฑ์ (PR-07)         |
| โดเมนการเงิน + ข้อความเงินภาษาไทย        | รายงานและการส่งออก (PR-09)           |
| ข้อมูลพื้นฐาน 8 ตาราง พร้อม RLS          |                                      |
| budget ledger แบบ append-only            |                                      |
| รายการจัดซื้อจัดจ้าง (ฉบับร่าง)          |                                      |
