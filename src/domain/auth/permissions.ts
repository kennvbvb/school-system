...
export const DEFAULT_ROLE_PERMISSIONS: Readonly<Record<RoleCode, readonly PermissionCode[]>> = {
  ...
  REVIEWER: ['masters.read', 'procurement.read.all', 'procurement.review', 'documents.preview'],
  APPROVER: ['masters.read', 'procurement.read.all', 'procurement.approve', 'documents.preview'],
  FINANCE: ['masters.read', 'procurement.read.all', 'reports.export'],
  INVENTORY_OFFICER: [
    'masters.read',
    'procurement.read.all',
    'inventory.read',
