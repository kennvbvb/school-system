...
-- ต้องกรอกเองให้ตรงกับความจริง (ชื่อและที่อยู่โรงเรียนคือคำถาม Q7)
--
-- ช่วงปีงบประมาณได้คำตอบแล้ว (1 ต.ค. – 30 ก.ย. คำตอบ Q6) แต่ **ปีไหนบ้าง**
-- ที่ต้องมีในระบบยังเป็นการตัดสินใจของโรงเรียน การใส่ปีสมมติไว้ในไฟล์ที่กำกับว่า
-- "ตัวอย่าง" เสี่ยงให้มีคนเผลอใช้ต่อโดยไม่แก้ — เพิ่มผ่านหน้า
-- /admin/master-data/fiscal-years ซึ่งเสนอช่วงวันที่ให้ตามกติกาที่ยืนยันแล้ว
-- -----------------------------------------------------------------------------
...
-- ต้องกรอกเองให้ตรงกับความจริง ตามเหตุผลด้านบน
